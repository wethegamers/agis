module github.com/wethegamers/agis
...
// Use local path during development, CI replaces with git reference
replace github.com/wethegamers/agis-core => ../agis-core

require (
	agones.dev/agones v1.38.0 // indirect
